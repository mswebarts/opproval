...
2. Search for "Order Approval by Customer for WooCommerce"
3. Click on Install button and activate.
...
4. Upload the download plugin uncompressed folder ( if using FTP ) or zip file ( if Hosting cPanel ). You must extract the file from hosting cPanel if you upload zip file
5. Then go to WordPress admin dashboard -> Plugins -> Installed Plugins -> Then activate Order Approval by Customer for WooCommerce
